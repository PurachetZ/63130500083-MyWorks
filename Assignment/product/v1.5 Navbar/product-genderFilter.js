...
function changeColorButton(e){
    ...
    genderFilterEle.childNodes.forEach(ele => {
        if(e.target == ele && ele.nodeType != 3){
            ele.setAttribute('class', 'btn btn-secondary mx-1');
        }
        else if(e.target != ele && ele.nodeType != 3){
            ele.setAttribute('class', 'btn btn-primary mx-1');
        }
    })
}
